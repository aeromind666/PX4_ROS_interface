...
class Agent:
    ...
    def actionVelYawrateSend(self, vel_x, vel_y, yaw_angle):
        msg = TwistStamped()
        msg.header.stamp = rospy.Time.now()
        msg.twist.linear.x = vel_x
        msg.twist.linear.y = vel_y
        msg.twist.angular.z = yaw_angle
...
def main():
    ...
    agent1 = Agent(topic_name='/uav1/algorithm/cmd_vel_yaw_angle')
    agent2 = Agent(topic_name='/uav2/algorithm/cmd_vel_yaw_angle')
    agent3 = Agent(topic_name='/uav3/algorithm/cmd_vel_yaw_angle')
    ...
    while not rospy.is_shutdown():
        ...
        agent2.actionVelYawrateSend(vel_x = 0, vel_y = 0.2, yaw_angle=-2)
